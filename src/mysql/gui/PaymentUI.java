...
public class PaymentUI extends javax.swing.JFrame {
    ...
    public PaymentUI(int id,String hotel) {
        try{
    ...
    private void initComponents() {
        ...
        jtbl_Payments = new javax.swing.JTable();
        ...
        jtbl_Payments.setFont(new java.awt.Font("Alata", 0, 12)); // NOI18N
        jtbl_Payments.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(jtbl_Payments);
    ...
    private void jtxt_SearchKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxt_SearchKeyTyped
        ...
        try{
            if(search.isEmpty()){
                ArrayList<Payment> list = payDAO.getHotelPayments(hotel_id);
                PaymentTableModel model = new PaymentTableModel(list);
                jtbl_Payments.setModel(model);
            } else {
                ArrayList<Payment> list = payDAO.searchHotelPayment(hotel_id,search);
                PaymentTableModel model = new PaymentTableModel(list);
                jtbl_Payments.setModel(model);
            }
        }
    ...
    private javax.swing.JTable jtbl_Payments;
